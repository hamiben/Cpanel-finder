...
'adm/index.php','wp/admin','affiliate.php','adm_auth.php','memberadmin.php','administratorlogin.php'
);
...
'adminarea/admin.cfm','adminarea/login.cfm','panel-administracion/index.cfm','panel-administracion/admin.cfm','wp/admin',
